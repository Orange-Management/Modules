...
class Controller extends ModuleAbstract implements WebInterface
{
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function viewLogList(RequestAbstract $request, ResponseAbstract $response, $data = null) : \Serializable
    {
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function viewLog(RequestAbstract $request, ResponseAbstract $response, $data = null) : \Serializable
    {
        $view = new View($this->app, $request, $response);
