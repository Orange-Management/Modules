            ...
            case DatabaseType::MYSQL:
                $dbPool->get('core')->con->prepare(
                    'CREATE TABLE if NOT EXISTS `' . $dbPool->get('core')->prefix . 'business_unit` (
                            ...
                            `business_unit_description` varchar(255) DEFAULT NULL,
                            `business_unit_parent` int(11) DEFAULT NULL,
                            `business_unit_created` datetime DEFAULT NULL,
                ...
                $dbPool->get('core')->con->prepare(
                    'CREATE TABLE if NOT EXISTS `' . $dbPool->get('core')->prefix . 'business_department` (
                            ...
                            `business_department_description` varchar(255) DEFAULT NULL,
                ...
                $dbPool->get('core')->con->prepare(
                    'INSERT INTO `' . $dbPool->get('core')->prefix . 'business_unit` (`business_unit_status`, `business_unit_matchcode`, `business_unit_name`, `business_unit_description`, `business_unit_parent`) VALUES
