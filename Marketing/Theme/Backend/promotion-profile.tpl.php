...
<div class="row">
            <div id="calendar" class="m-calendar m-calendar-mini col-xs-12 col-md-6" draggable="true" data-action='[
                ...
                <?php $current = $promotion->getCalendar()->getDate()->getMonthCalendar(0); $isActiveMonth = false;
                for($i = 0; $i < 6; $i++) : ?>
                <ul class="days">
                    <?php for($j = 0; $j < 7; $j++) : 
                    ...
                    ?>
                        ...
                        <li class="day<?= $promotion->getCalendar()->hasEventOnDate($current[$i*7+$j]) ? ' has-event' : '';?>">
                            <div class="date"><?= $current[$i*7+$j]->format('d'); ?></div>
                                <?php else: ?>
                        <li class="day other-month<?= $promotion->getCalendar()->hasEventOnDate($current[$i*7+$j]) ? ' has-event' : '';?>">
                            <div class="date"><?= $current[$i*7+$j]->format('d'); ?></div>
                        <?php endif; ?>
                    <?php endfor; ?>
                    </li>
    ...
    <div class="col-xs-12 col-md-6">
        <div class="box wf-100">
            <table class="table blue">
                ...
                <tfoot>
                <tbody>
                    <?php $count = 0; $media = $promotion->getMedia(); foreach($media as $key => $value) : $count++;
