...
<div class="box w-100">
    <table class="table">
        <caption><?= $this->l11n->getText('ItemManagement', 'Stock'); ?></caption>
        <thead>
        <tr>
            <td><?= $this->l11n->getText(0, 'ID'); ?>
            <td class="wf-100"><?= $this->l11n->getText('ItemManagement', 'Article'); ?>
            <td><?= $this->l11n->getText('ItemManagement', 'Quantity'); ?>
        <tfoot>
