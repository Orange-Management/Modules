...
<div class="box w-100">
    <table class="table">
        ...
        <thead>
        <tr>
            <td><?= $this->l11n->lang['PersonnelTimeManagement']['Start']; ?>
            <td><?= $this->l11n->lang['PersonnelTimeManagement']['End']; ?>
            <td class="wf-100"><?= $this->l11n->lang['PersonnelTimeManagement']['Type']; ?>
        <tfoot>
