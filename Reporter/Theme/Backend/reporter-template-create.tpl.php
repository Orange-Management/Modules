...
<div class="row">
            ...
            <div class="inner">
                <form id="reporter-template-create" action="<?= \phpOMS\Uri\UriFactory::build('/{/lang}/api/reporter/report/template'); ?>" method="post">
                    <table class="layout wf-100" style="table-layout: fixed">
                        ...
                        <tr><td><?= $this->getData('editor')->getData('text')->render('report-editor', 'description', 'reporter-template-create'); ?>
                        <tr><td>
                                <span class="checkbox">
    ...
    <div class="col-xs-12 col-md-6">
        <?= $this->getData('media-upload')->render('reporter-template-create'); ?>
    </div>
</div>